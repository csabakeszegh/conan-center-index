...
class SDLImageConan(ConanFile):
    ...
    def package(self):
        ...
        rmdir(self, os.path.join(self.package_folder, "lib", "pkgconfig"))
        rmdir(self, os.path.join(self.package_folder, "share"))
        rmdir(self, os.path.join(self.package_folder, "SDL_image.framework"))
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property("pkg_config_name", "SDL3_image")
        # TODO: back to global scope in conan v2 once legacy generators removed
        self.cpp_info.components["_sdl_image"].libs = [f"SDL3_image{lib_postfix}"]
        self.cpp_info.components["_sdl_image"].includedirs.append(os.path.join("include", "SDL3_image"))

        # TODO: to remove in conan v2 once legacy generators removed
        self.cpp_info.components["_sdl_image"].set_property("cmake_target_name", "SDL3_image::SDL3_image")
        self.cpp_info.components["_sdl_image"].set_property("pkg_config_name", "SDL3_image")
        self.cpp_info.components["_sdl_image"].requires = ["sdl::sdl3"]
        if self.options.with_libtiff:
